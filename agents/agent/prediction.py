...
from .base import ToolAwareAgent, AsyncToolAwareAgent
...
class AsyncPredictionAgent(AsyncToolAwareAgent):
    parallel: bool = True
    answer: list[str]
    def __init__(
        self,
        ...
        **oai_kwargs,
        ...
        """
        Asyncio variant of PredictionAgent class. run() or __call__ should be managed as an async co-routine.
        The output is a prediction for each row of `df` from one of the choices in `labels`
